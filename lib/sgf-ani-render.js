...
(function() {
  ...
  SgfAniRender = (function() {
    ...
    function SgfAniRender(parentElement, background, fixedCanvasWidth, fixedCanvasHeight) {
      ...
      this.btnBgColor = this.paper.rect(this.paper.width - 21, this.paper.height - 21, 16, 16);
      ...
      this.btnRegControl = this.paper.image(SgfAniRender.ICON_AIM, this.paper.width - 47, this.paper.height - 21, 16, 16).drag(SgfAniRender.move, SgfAniRender.start, SgfAniRender.up).parent = this;
      this.setBackground(background);
    }

    SgfAniRender.prototype.load = function(url, title) {
