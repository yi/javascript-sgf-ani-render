...
(function() {
  ...
  SgfAniRender = (function() {
    ...
    SgfAniRender.prototype.load = function(wuid, url) {
    ...
    SgfAniRender.prototype.setPlayScript = function(script) {
      ...
      if (script === "") {
        ...
        for (i = _j = 0, _ref1 = script.length; _j < _ref1; i = _j += 1) {
          cmd = script.charAt(i);
          if (cmd === "^") {
            this.frameIdToSoundTrigger[this.frames.length - 1] = soundWuids.shift();
            continue;
          }
          if (cmd === "+") {
            ++currentAssetFrame;
    ...
    SgfAniRender.prototype.displayLabel = function(msg) {
      this.label = this.label || this.paper.text(10, 15, String(msg));
      msg = String(msg || "").trim();
      msg = msg.replace('{fps}', this.fps).replace('{assetFrameNum}', this.assetFrameNum);
      this.label.attr({
        "font-family": "arial",
        "font-size": "14",
        "text-anchor": "start",
